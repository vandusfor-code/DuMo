...
const CHANNEL_STYLES: Record<ConversationChannel, { bg: string; Icon: ComponentType<{ className?: string }> }> = {
  whatsapp: { bg: "bg-[#25D366]", Icon: WhatsAppGlyph },
  web_qr: { bg: "bg-[#25D366]", Icon: WhatsAppGlyph },
  messenger: { bg: "bg-[#0084FF]", Icon: Facebook },

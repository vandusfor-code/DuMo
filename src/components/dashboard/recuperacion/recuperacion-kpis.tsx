...
import type { AdvisorRecuperacionSummary } from "@/types/advisor-recuperacion";

export function RecuperacionKpis({ summary }: { summary: AdvisorRecuperacionSummary }) {
  const cards = [
    {
      icon: <ClipboardList />,
      tint: "bg-brand-soft text-brand",
      label: "Total en recuperación",
      value: summary.totalPending,
      sub: "Transferidos a ti",
    },
    {
      icon: <ReceiptText />,
